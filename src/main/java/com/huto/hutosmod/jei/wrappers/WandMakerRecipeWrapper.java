...
public class WandMakerRecipeWrapper implements IRecipeWrapper {

	private final List<List<ItemStack>> input;
	private final ItemStack output;
	private final float manaUsage;
	private RecipeWandMaker currentRecipe;

	public WandMakerRecipeWrapper(RecipeWandMaker recipe) {
