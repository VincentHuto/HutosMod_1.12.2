...
public class RegistryHandler {
	...
	public static void onModelRegister(ModelRegistryEvent event) {
		...
		/*
		 * ClientRegistry.bindTileEntitySpecialRenderer(TileEntityEssecenceEnhancer.
		 * class, new RenderTileEssecenceEnhancer());
		 */
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityVibratorySelector.class,
				new RenderTileVibratorySelector());
	...
	public static void preInitRegistries(FMLPreInitializationEvent event) {
		...
		GameRegistry.registerWorldGenerator(new IWorldGenCustomMushroom(), 10);
