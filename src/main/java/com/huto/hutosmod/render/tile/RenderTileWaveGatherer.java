...
public class RenderTileWaveGatherer extends TileEntitySpecialRenderer<TileEntityWaveGatherer> {


	@Override
	public void render(@Nonnull TileEntityWaveGatherer te, double x, double y, double z, float partticks,
