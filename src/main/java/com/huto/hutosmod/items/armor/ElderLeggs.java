...
public class ElderLeggs extends ItemArmor {

	public ElderLeggs(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(materialIn, renderIndexIn, equipmentSlotIn);
		this.setRegistryName("elder_leggings");
		this.setUnlocalizedName("elder_leggings");
...
/*	@Override
	...
	public net.minecraft.client.model.ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack,
		...
		if (itemStack != null) {
			if (itemStack.getItem() instanceof ElderLeggs) {
