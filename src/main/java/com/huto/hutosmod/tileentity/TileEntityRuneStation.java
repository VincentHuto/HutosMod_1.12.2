...
public class TileEntityRuneStation extends TileEntityLockableLoot implements ITickable {
	...
	public String getName() {
		return this.hasCustomName() ? this.customName : "Runic Workstation";
	}
	...
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		return new ContainerRuneStation(playerInventory, this, playerIn);
	}
	...
	public void update() {
		if (!this.world.isRemote && this.numPlayersUsing != 0
			...
			for (EntityPlayer entityplayer : this.world.getEntitiesWithinAABB(EntityPlayer.class,
				...
				if (entityplayer.openContainer instanceof ContainerRuneStation) {
					if (((ContainerRuneStation) entityplayer.openContainer).getChestInventory() == this) {
