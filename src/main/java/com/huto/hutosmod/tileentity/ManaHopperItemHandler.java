...
public class ManaHopperItemHandler extends InvWrapper
{
    private final TileEntityManaHopper hopper;

    public ManaHopperItemHandler(TileEntityManaHopper hopper)
    {
        super(hopper);
        this.hopper = hopper;
    }
