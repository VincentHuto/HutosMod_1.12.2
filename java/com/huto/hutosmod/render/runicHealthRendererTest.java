...
public class runicHealthRendererTest extends Gui {
  ...
  private final static ResourceLocation overlayBar = new ResourceLocation(Reference.MODID,
          "textures/gui/mbe40_hud_overlay1.png");
  ...
  public runicHealthRendererTest(Minecraft mc) {
    this.mc = mc;
  }
  ...
  public void renderStatusBar(int screenWidth, int screenHeight) {
    ...
    GL11.glTranslatef(vanillaExpLeftX-100, vanillaExpTopY - BAR_SPACING_ABOVE_EXP_BAR - BAR_HEIGHT, 0);
...
//    final int REGEN_EFFECT_ID = 10; is now MobEffects.REGENERATION
    ...
    final int REGEN_TEXTURE_U = BAR_WIDTH + 10;  //  green texels
    final int POISON_TEXTURE_U = BAR_WIDTH + 11;  // black texels
    final int WITHER_TEXTURE_U = BAR_WIDTH + 12;  // brown texels
    ...
    if (player.isPotionActive(MobEffects.WITHER)) {
      ...
      float healthRatio=effectiveHp/maxHp;
      System.out.println(healthRatio);
      //GL11.glScalef(0.0625f, 2.5f, 0F);
      int widthTrim = (int) ((int) (90)-(NORMAL_TEXTURE_U*healthRatio));
      System.out.println(widthTrim);
      //First 4 are texture size and location
      GL11.glScalef(1f, 1f, 1);
      GL11.glTranslatef(100,-20, 0);
      drawModalRectWithCustomSizedTexture(0, 0, 0, 0, 90-widthTrim, BAR_HEIGHT-2, 257, 200);
