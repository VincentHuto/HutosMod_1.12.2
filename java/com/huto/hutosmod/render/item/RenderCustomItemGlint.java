...
public class RenderCustomItemGlint extends RenderItem {
	private static final ResourceLocation RES_ITEM_GLINT = new ResourceLocation(
			"textures/misc/enchanted_item_glint.png");

	private final RenderItem originalRenderItem;

	public RenderCustomItemGlint(RenderItem parRenderItem, ModelManager modelManager) // , ItemColors parItemColors,
