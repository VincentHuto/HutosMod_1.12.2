...
public class RenderTileManaCapacitor extends TileEntitySpecialRenderer<TileEntityManaCapacitor> {
	...
	@Override
	public void render(@Nonnull TileEntityManaCapacitor te, double x, double y, double z, float partticks,
	...
	if (heightModifier > 0.75)
		...
		for (int k = 0; k < te.getSizeInventory(); k++) {
			GlStateManager.pushMatrix();
			GlStateManager.translate(0.5F, 1.3F, 0.5F);
