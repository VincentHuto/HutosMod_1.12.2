package com.huto.hutosmod.dimension.netherTemplate;
...
public class NetherGenTemplate implements IChunkGenerator
{
    ...
    protected static final IBlockState BEDROCK = Blocks.BLACK_GLAZED_TERRACOTTA.getDefaultState();
    
    //Block that is usually Netherrack
    protected static final IBlockState MAIN_BLOCK = Blocks.OBSIDIAN.getDefaultState();
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(Biomes.HELL);
        }
