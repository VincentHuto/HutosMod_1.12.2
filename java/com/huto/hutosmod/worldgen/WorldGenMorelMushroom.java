...
public class WorldGenMorelMushroom extends WorldGenerator {
	...
	public WorldGenMorelMushroom(Block p_i46449_1_) {
		super(true);
		this.mushroomType = p_i46449_1_;
	}

	public WorldGenMorelMushroom() {
		super(false);
						...
						for (int l1 = k3; l1 <= l3; ++l1) {
							for (int i2 = j1; i2 <= k1; ++i2) {
								...
								if (position.getY() >= position.getY() + i - 1
									...
									BlockPos blockpos5 = new BlockPos(position.getX(), position.getY()+(i+4),position.getZ());
