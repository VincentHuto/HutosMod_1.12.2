...
public class GuiMindRunes extends InventoryEffectRenderer {

	public static final ResourceLocation background =
			new ResourceLocation(Reference.MODID,"textures/gui/gui_mind_runes.png");
	...
	public GuiMindRunes(EntityPlayer player)
	{
	...
	{
		((ContainerPlayerExpanded)inventorySlots).runes.setEventBlock(false);
	...
	protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_)
	{
		...
		this.fontRenderer.drawString(I18n.format("container.crafting", new Object[0]), 115-18, 8+22, 4210752);
	}
	...
	protected void keyTyped(char par1, int par2) throws IOException {
		if (par2 == KeyBindRegistry.KEY_RUNES.getKeyCode())
		{
