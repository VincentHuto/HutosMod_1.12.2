...
public class EntityElemental extends EntityMob {
	...
	private static final DataParameter<Byte> ON_FIRE = EntityDataManager.<Byte>createKey(EntityElemental.class,
	...
	public static void registerFixesBlaze(DataFixer fixer) {
		EntityLiving.registerFixesMob(fixer, EntityElemental.class);
	}

	protected void initEntityAI() {
		this.tasks.addTask(4, new EntityElemental.AIFireballAttack(this));
	...
	static class AIFireballAttack extends EntityAIBase {
		private final EntityElemental blaze;
		private int attackStep;
		private int attackTime;

		public AIFireballAttack(EntityElemental blazeIn) {
			this.blaze = blazeIn;
			this.setMutexBits(3);
		}
