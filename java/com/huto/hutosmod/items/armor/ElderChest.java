...
public class ElderChest extends ItemArmor {

	public ElderChest(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(materialIn, renderIndexIn, equipmentSlotIn);
		this.setRegistryName("elder_chestplate");
		this.setUnlocalizedName("elder_chestplate");
...
/*
	...
	public net.minecraft.client.model.ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack,
		...
		if (itemStack != null) {
			if (itemStack.getItem() instanceof ElderChest) {
