...
public class ItemRuneEye extends ItemRune implements IRune {

	public ItemRuneEye(String name) {
		super(name);
		//setLevel(2);
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		if (itemstack.getItemDamage() == 0 && player.ticksExisted % 1 ==0) {
			player.addPotionEffect(new PotionEffect(MobEffects.NIGHT_VISION, 250, this.getLevel(), false, false));
		}
	}
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(TextFormatting.GRAY + "Effect:Night Vision");
