...
public class ItemRuneLake extends ItemRune implements IRune {

	public ItemRuneLake(String name) {
		super(name);
		//setLevel(2);
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		if (itemstack.getItemDamage() == 0 && player.ticksExisted % 1 ==0) {
			player.addPotionEffect(new PotionEffect(MobEffects.WATER_BREATHING, 250, 0, true, true));
		}
	}
