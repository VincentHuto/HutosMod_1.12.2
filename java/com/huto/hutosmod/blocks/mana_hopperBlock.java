...
import com.huto.hutosmod.tileentity.TileEntityManaHopper;
...
public class mana_hopperBlock extends BlockContainer
{
    ...
    public mana_hopperBlock(String name, Material material)
    {
    ...
    {
        return new TileEntityManaHopper();
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityManaHopper)
            {
                ((TileEntityManaHopper)tileentity).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityManaHopper)
            {
                playerIn.displayGUIChest((TileEntityManaHopper)tileentity);
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (tileentity instanceof TileEntityManaHopper)
        {
            InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityManaHopper)tileentity);
