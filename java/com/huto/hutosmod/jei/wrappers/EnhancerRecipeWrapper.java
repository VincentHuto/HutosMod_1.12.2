...
public class EnhancerRecipeWrapper implements IRecipeWrapper {

	private final List<List<ItemStack>> input;
	private final ItemStack output;
	private final float manaUsage;
	private RecipeEnhancer currentRecipe;

	public EnhancerRecipeWrapper(RecipeEnhancer recipe) {
	...
	public void drawInfo(@Nonnull Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
		...
		TileEntityEssecenceEnhancer te = new TileEntityEssecenceEnhancer();
