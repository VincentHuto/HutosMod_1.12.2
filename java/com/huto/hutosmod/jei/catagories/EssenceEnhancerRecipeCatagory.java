...
public class EssenceEnhancerRecipeCatagory implements IRecipeCategory<EnhancerRecipeWrapper> {

	public static final String UID = "enhancer";
	private final IDrawable background;
	private final String localizedName;
	private final IDrawable overlay;

	public EssenceEnhancerRecipeCatagory(IGuiHelper guiHelper) {
		background = guiHelper.createBlankDrawable(150, 110);
		localizedName = I18n.format("hutosmod.jei.essenceenhancer");
	...
	@Override
	public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull EnhancerRecipeWrapper recipeWrapper,
			@Nonnull IIngredients ingredients) {
		recipeLayout.getItemStacks().init(0, true, 64, 52);
		GlStateManager.pushMatrix();
		GlStateManager.scale(1.2, 4.2, 1.2);
		recipeLayout.getItemStacks().set(0, new ItemStack(BlockRegistry.essecence_enhancer));
