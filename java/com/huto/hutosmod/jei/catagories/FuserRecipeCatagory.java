...
public class FuserRecipeCatagory implements IRecipeCategory<FuserRecipeWrapper> {

	public static final String UID = "fuser";
	...
	@Override
	public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull FuserRecipeWrapper recipeWrapper,
			@Nonnull IIngredients ingredients) {
		recipeLayout.getItemStacks().init(0, true, 64, 52);
		GlStateManager.pushMatrix();
		GlStateManager.scale(1.2, 4.2, 1.2);
		recipeLayout.getItemStacks().set(0, new ItemStack(BlockRegistry.mana_fuser));
