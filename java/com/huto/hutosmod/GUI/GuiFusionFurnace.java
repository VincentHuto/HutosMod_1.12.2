...
public class GuiFusionFurnace extends GuiContainer{
	...
	public GuiFusionFurnace(InventoryPlayer player, TileEntityFusionFurnace tileentity) 
	{
		super(new ContainerFusionFurnace(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		if(TileEntityFusionFurnace.isBurning(tileentity))
		{
