...
public class TileEntityHandler {
	...
	//	GameRegistry.registerTileEntity(TileEntityEssecenceEnhancer.class, "esscence_enhancer");
		...
		GameRegistry.registerTileEntity(TileEntityManaAbsorber.class, "mana_absorber");
		GameRegistry.registerTileEntity(TileEntitySlimeRepelent.class, "slime_repelent");
