...
public class TileEntityFusionFurnace extends TileEntity implements ITickable {
	...
	{
		return this.hasCustomName() ? new TextComponentString(this.customName) : new TextComponentTranslation("container.fusion_furnace");
	}
	...
	public static boolean isBurning(TileEntityFusionFurnace te) 
	{
