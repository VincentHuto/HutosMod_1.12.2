...
public class runicHealthRenderer extends Gui {
	 ...
	 * Minecraft.getMinecraft() here, but this won't always be possible if you want
	 * to include information that's part of another class.
	 */
	private Minecraft mc;

	public runicHealthRenderer(Minecraft mc) {
		this.mc = mc;
	}
