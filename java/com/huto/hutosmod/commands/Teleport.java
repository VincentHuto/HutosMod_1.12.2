...
public class Teleport extends Teleporter{
	...
	public static void teleportToDimention(EntityPlayer player,int dimension,double x,double y,double z) {
		...
		if(worldServer == null || server ==null)throw new IllegalArgumentException("Dimension: " + dimension + " doesnt exist");
